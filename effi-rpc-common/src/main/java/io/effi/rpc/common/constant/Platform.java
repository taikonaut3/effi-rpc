...
/**
 * Platform for get version and jvm status.
 */
public final class Platform {
    ...
    static {
        try {
            InputStream stream = Platform.class.getClassLoader().getResourceAsStream("effi-rpc-version");
            if (stream == null) {
                throw new IllegalStateException("Can‘t find virtue-version file");
            }
